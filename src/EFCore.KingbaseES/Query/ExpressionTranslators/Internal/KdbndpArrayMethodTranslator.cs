...
/// </summary>
/// <remarks>
///     https://www.KingbaseES.org/docs/current/static/functions-array.html
/// </remarks>
public class KdbndpArrayMethodTranslator : IMethodCallTranslator
{
    #region Methods
    ...
    /// </summary>
    public KdbndpArrayMethodTranslator(KdbndpSqlExpressionFactory sqlExpressionFactory, KdbndpJsonPocoTranslator jsonPocoTranslator)
    {
        ...
        IDiagnosticsLogger<DbLoggerCategory.Query> logger)
    {
        ...
        if (method.IsClosedFormOf(Enumerable_ElementAt))
        {
            ...
            if (arguments[0].TypeMapping is KdbndpByteArrayTypeMapping)
            {
        ...
        static bool IsMappedToNonArray(SqlExpression arrayOrList)
            => arrayOrList.TypeMapping is { } and not (KdbndpArrayTypeMapping or KdbndpJsonTypeMapping);
