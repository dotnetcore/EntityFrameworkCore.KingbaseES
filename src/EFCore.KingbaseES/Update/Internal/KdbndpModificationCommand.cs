...
/// </summary>
public class KdbndpModificationCommand : ModificationCommand
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public KdbndpModificationCommand(in ModificationCommandParameters modificationCommandParameters)
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public KdbndpModificationCommand(in NonTrackedModificationCommandParameters modificationCommandParameters)
        : base(in modificationCommandParameters)
    {
    }
    ...
    public override void PropagateResults(RelationalDataReader relationalReader)
    {
        ...
        // However, in KingbaseES, output parameters actually get returned as the result set, so we override and take care of that here.
