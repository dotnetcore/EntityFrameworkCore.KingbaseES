...
public class KdbndpQuerySqlGenerator : QuerySqlGenerator
{
    ...
    protected override string GetOperator(SqlBinaryExpression e)
        => e.OperatorType switch
        {
            ...
            // In most databases/languages, the caret (^) is the bitwise XOR operator. But in KingbaseES the caret is the exponentiation
            ...
            .Append(
                binaryExpression.OperatorType switch
                {
                    PgExpressionType.Contains
                        when binaryExpression.Left.TypeMapping is KdbndpInetTypeMapping or KdbndpCidrTypeMapping
                        => ">>",
    ...
    /// <summary>
    ///     Produces SQL for KingbaseES regex matching.
    /// </summary>
    /// <remarks>
