...
public class KdbndpTimestampTypeMapping : KdbndpTypeMapping
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public sealed class KdbndpJsonTimestampReaderWriter : JsonValueReaderWriter<DateTime>
    {
        private static readonly PropertyInfo InstanceProperty = typeof(KdbndpJsonTimestampReaderWriter).GetProperty(nameof(Instance))!;
