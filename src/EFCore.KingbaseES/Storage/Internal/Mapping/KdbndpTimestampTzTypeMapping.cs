...
public class KdbndpTimestampTzTypeMapping : KdbndpTypeMapping
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public sealed class KdbndpJsonTimestampTzDateTimeReaderWriter : JsonValueReaderWriter<DateTime>
    {
        private static readonly PropertyInfo InstanceProperty
            = typeof(KdbndpJsonTimestampTzDateTimeReaderWriter).GetProperty(nameof(Instance))!;
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public sealed class KdbndpJsonTimestampTzDateTimeOffsetReaderWriter : JsonValueReaderWriter<DateTimeOffset>
    {
        private static readonly PropertyInfo InstanceProperty
            = typeof(KdbndpJsonTimestampTzDateTimeOffsetReaderWriter).GetProperty(nameof(Instance))!;
