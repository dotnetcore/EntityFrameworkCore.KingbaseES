...
///     requires
///     that a lookup of the CLR type <see cref="JsonElement" /> return the provider's special <see cref="JsonTypeMapping" />. But Kdbndp has
...
/// </summary>
public class KdbndpJsonElementHackConvention : IPropertyAddedConvention
{
    private KdbndpJsonTypeMapping? _jsonTypeMapping;
    ...
    public void ProcessPropertyAdded(IConventionPropertyBuilder propertyBuilder, IConventionContext<IConventionPropertyBuilder> context)
    {
        ...
        {
            property.SetTypeMapping(_jsonTypeMapping ??= new KdbndpJsonTypeMapping("jsonb", typeof(JsonElement)));
        }
    }
}
