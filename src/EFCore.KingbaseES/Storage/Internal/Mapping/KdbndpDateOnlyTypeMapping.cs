...
public class KdbndpDateOnlyTypeMapping : KdbndpTypeMapping
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public sealed class KdbndpJsonDateOnlyReaderWriter : JsonValueReaderWriter<DateOnly>
    {
        private static readonly PropertyInfo InstanceProperty = typeof(KdbndpJsonDateOnlyReaderWriter).GetProperty(nameof(Instance))!;
