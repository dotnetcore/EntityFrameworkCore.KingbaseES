...
public static class KdbndpNetworkDbFunctionsExtensions
{
    ...
    /// <summary>
    ///     Determines whether an <see cref="KdbndpInet" /> is less than another <see cref="KdbndpInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The left-hand inet.</param>
    /// <param name="other">The right-hand inet.</param>
    /// <returns>
    ///     True if the <see cref="KdbndpInet" /> is less than the other <see cref="KdbndpInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool LessThan(this DbFunctions _, KdbndpInet inet, KdbndpInet other)
    ...
    /// <summary>
    ///     Determines whether an <see cref="KdbndpInet" /> is less than or equal to another <see cref="KdbndpInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The left-hand inet.</param>
    /// <param name="other">The right-hand inet.</param>
    /// <returns>
    ///     True if the <see cref="KdbndpInet" /> is less than or equal to the other <see cref="KdbndpInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool LessThanOrEqual(this DbFunctions _, KdbndpInet inet, KdbndpInet other)
    ...
    /// <summary>
    ///     Determines whether an <see cref="KdbndpInet" /> is greater than or equal to another <see cref="KdbndpInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The left-hand inet.</param>
    /// <param name="other">The right-hand inet.</param>
    /// <returns>
    ///     True if the <see cref="KdbndpInet" /> is greater than or equal to the other <see cref="KdbndpInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool GreaterThanOrEqual(this DbFunctions _, KdbndpInet inet, KdbndpInet other)
    ...
    /// <summary>
    ///     Determines whether an <see cref="KdbndpInet" /> is greater than another <see cref="KdbndpInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The left-hand inet.</param>
    /// <param name="other">The right-hand inet.</param>
    /// <returns>
    ///     True if the <see cref="KdbndpInet" /> is greater than the other <see cref="KdbndpInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool GreaterThan(this DbFunctions _, KdbndpInet inet, KdbndpInet other)
    ...
    /// <summary>
    ///     Determines whether an <see cref="KdbndpInet" /> is contained within another <see cref="KdbndpInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The inet to locate.</param>
    /// <param name="other">The inet to search.</param>
    /// <returns>
    ///     True if the <see cref="KdbndpInet" /> is contained within the other <see cref="KdbndpInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool ContainedBy(this DbFunctions _, KdbndpInet inet, KdbndpInet other)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(ContainedBy)));

    /// <summary>
    ///     Determines whether an <see cref="KdbndpInet" /> is contained within or equal to another <see cref="KdbndpInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The inet to locate.</param>
    /// <param name="other">The inet to search.</param>
    /// <returns>
    ///     True if the <see cref="KdbndpInet" /> is contained within or equal to the other <see cref="KdbndpInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool ContainedByOrEqual(this DbFunctions _, KdbndpInet inet, KdbndpInet other)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(ContainedByOrEqual)));

    /// <summary>
    ///     Determines whether an <see cref="KdbndpInet" /> contains another <see cref="KdbndpInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The IP address to search.</param>
    /// <param name="other">The IP address to locate.</param>
    /// <returns>
    ///     True if the <see cref="KdbndpInet" /> contains the other <see cref="KdbndpInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool Contains(this DbFunctions _, KdbndpInet inet, KdbndpInet other)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(Contains)));

    /// <summary>
    ///     Determines whether an <see cref="KdbndpInet" /> contains or is equal to another <see cref="KdbndpInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The IP address to search.</param>
    /// <param name="other">The IP address to locate.</param>
    /// <returns>
    ///     True if the <see cref="KdbndpInet" /> contains or is equal to the other <see cref="KdbndpInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool ContainsOrEqual(this DbFunctions _, KdbndpInet inet, KdbndpInet other)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(ContainsOrEqual)));

    /// <summary>
    ///     Determines whether an <see cref="KdbndpInet" /> contains or is contained by another <see cref="KdbndpInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The IP address to search.</param>
    /// <param name="other">The IP address to locate.</param>
    /// <returns>
    ///     True if the <see cref="KdbndpInet" /> contains or is contained by the other <see cref="KdbndpInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool ContainsOrContainedBy(this DbFunctions _, KdbndpInet inet, KdbndpInet other)
    ...
    /// <summary>
    ///     Computes the bitwise NOT operation on an <see cref="KdbndpInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static KdbndpInet BitwiseNot(this DbFunctions _, KdbndpInet inet)
    ...
    /// <summary>
    ///     Computes the bitwise AND of two <see cref="KdbndpInet" /> instances.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The left-hand inet.</param>
    /// <param name="other">The right-hand inet.</param>
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static KdbndpInet BitwiseAnd(this DbFunctions _, KdbndpInet inet, KdbndpInet other)
    ...
    /// <summary>
    ///     Computes the bitwise OR of two <see cref="KdbndpInet" /> instances.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The left-hand inet.</param>
    /// <param name="other">The right-hand inet.</param>
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static KdbndpInet BitwiseOr(this DbFunctions _, KdbndpInet inet, KdbndpInet other)
    ...
    /// <summary>
    ///     Adds the <paramref name="value" /> to the <see cref="KdbndpInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The inet.</param>
    /// <param name="value">The value to add.</param>
    /// <returns>
    ///     The <see cref="KdbndpInet" /> augmented by the <paramref name="value" />.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static KdbndpInet Add(this DbFunctions _, KdbndpInet inet, int value)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(Add)));

    /// <summary>
    ///     Subtracts the <paramref name="value" /> from the <see cref="KdbndpInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The inet.</param>
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static KdbndpInet Subtract(this DbFunctions _, KdbndpInet inet, long value)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(Subtract)));

    /// <summary>
    ///     Subtracts one <see cref="KdbndpInet" /> from another <see cref="KdbndpInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static int Subtract(this DbFunctions _, KdbndpInet inet, KdbndpInet other)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(Subtract)));
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static string Abbreviate(this DbFunctions _, KdbndpInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static string Abbreviate(this DbFunctions _, KdbndpCidr cidr)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(Abbreviate)));
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static KdbndpInet Broadcast(this DbFunctions _, KdbndpInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static int Family(this DbFunctions _, KdbndpInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static string Host(this DbFunctions _, KdbndpInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static KdbndpInet HostMask(this DbFunctions _, KdbndpInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static int MaskLength(this DbFunctions _, KdbndpInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static KdbndpInet Netmask(this DbFunctions _, KdbndpInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static KdbndpCidr Network(this DbFunctions _, KdbndpInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static KdbndpInet SetMaskLength(this DbFunctions _, KdbndpInet inet, int length)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static KdbndpCidr SetMaskLength(this DbFunctions _, KdbndpCidr cidr, int length)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(SetMaskLength)));
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static string Text(this DbFunctions _, KdbndpInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool SameFamily(this DbFunctions _, KdbndpInet inet, KdbndpInet other)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static KdbndpCidr Merge(this DbFunctions _, KdbndpInet inet, KdbndpInet other)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    [Obsolete("Use the overload which accepts KdbndpCidr", error: true)]
