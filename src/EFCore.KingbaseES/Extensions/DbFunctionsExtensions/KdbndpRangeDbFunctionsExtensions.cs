...
public static class KdbndpRangeDbFunctionsExtensions
{
    ...
    /// <seealso href="https://www.KingbaseES.org/docs/current/functions-aggregate.html">KingbaseES documentation for aggregate functions.</seealso>
    /// <exception cref="NotSupportedException">
    ///     <see cref="RangeIntersectAgg{T}(IEnumerable{KdbndpRange{T}})" /> is only intended for use via SQL translation as part of an EF Core
    ///     LINQ query.
    /// </exception>
    ...
    ///     Corresponds to the KingbaseES <c>range_intersect_agg</c> aggregate function.
    /// </summary>
