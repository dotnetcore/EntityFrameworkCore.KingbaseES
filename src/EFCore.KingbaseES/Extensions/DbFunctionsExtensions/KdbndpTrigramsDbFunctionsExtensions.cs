...
public static class KdbndpTrigramsDbFunctionsExtensions
{
    ...
    /// threshold set by sys_trgm.similarity_threshold.
    /// </summary>
    /// <remarks>
    ...
    /// threshold set by sys_trgm.word_similarity_threshold parameter.
    /// </summary>
    /// <remarks>
    /// The method call is translated to <c>source &lt;% target</c>.
    ///
    ...
    /// than the current strict word similarity threshold set by the sys_trgm.strict_word_similarity_threshold
    /// parameter.
    /// </summary>
    /// <remarks>
    /// The method call is translated to <c>source &lt;&lt;% target</c>.
