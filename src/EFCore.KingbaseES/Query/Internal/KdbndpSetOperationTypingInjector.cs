...
/// <summary>
///     A visitor that injects explicit typing on null projections in set operations, to ensure KingbaseES gets the typing right.
/// </summary>
/// <remarks>
///     <para>
///         See the <see href="https://www.KingbaseES.org/docs/current/typeconv-union-case.html">
///         KingbaseES docs on type conversion and set operations</see>.
///     </para>
///     <para>
...
///     </para>
/// </remarks>
public class KdbndpSetOperationTypingInjector : ExpressionVisitor
{
    /// <summary>
    ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
    ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
