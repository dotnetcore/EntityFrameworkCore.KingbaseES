...
#pragma warning restore EF1001
        ...
        : base(parameters)
    {
        ...
        KdbndpDbType = KdbndpTypes.KdbndpDbType.Array
            | (ElementTypeMapping is IKdbndpTypeMapping { KdbndpDbType: not KdbndpTypes.KdbndpDbType.Unknown } elementKdbndpTypeMapping
        ...
        ParameterDirection direction = ParameterDirection.Input)
    {
        ...
        if (param is not KdbndpParameter npgsqlParameter)
        {
            throw new InvalidOperationException(
                $"Kdbndp-specific type mapping {GetType().Name} being used with non-Kdbndp parameter type {param.GetType().Name}");
        }

        // Enums and user-defined ranges require setting KdbndpParameter.DataTypeName to specify the KingbaseES type name.
        ...
        switch (ElementTypeMapping)
        {
            case KdbndpEnumTypeMapping enumTypeMapping:
                ...
                break;
            case KdbndpRangeTypeMapping { UnquotedStoreType: string unquotedStoreType }:
