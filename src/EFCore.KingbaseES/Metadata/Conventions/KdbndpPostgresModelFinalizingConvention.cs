...
public class KdbndpPostgresModelFinalizingConvention : IModelFinalizingConvention
{
    ...
    public KdbndpPostgresModelFinalizingConvention(
    ...
    /// <summary>
    ///     Configures the model to create KingbaseES enums based on the user's enum definitions in the context options.
    /// </summary>
