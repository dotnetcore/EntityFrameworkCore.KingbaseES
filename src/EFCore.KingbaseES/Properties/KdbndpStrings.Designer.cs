...
namespace Kdbndp.EntityFrameworkCore.KingbaseES.Internal
{
    ...
    public static class KdbndpStrings
    {
        ...
        /// <summary>
        ///     ConfigureDataSource() cannot be used when an externally-provided KdbndpDataSource is passed to UseKdbndp(). Either perform all data source configuration on the external KdbndpDataSource, or pass a connection string to UseKdbndp() and specify the data source configuration there.
        /// </summary>
        ...
        /// <summary>
        ///     The EF Core 7.0 JSON support isn't currently supported by the Kdbndp provider. To map to JSON, see https://www.npgsql.org/efcore/mapping/json.html.
        /// </summary>
