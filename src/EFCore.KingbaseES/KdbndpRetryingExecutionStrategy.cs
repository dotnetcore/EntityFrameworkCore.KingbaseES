...
public class KdbndpRetryingExecutionStrategy : ExecutionStrategy
{
    ...
    // and expose them via error codes, we have KingbaseException with an inner exception.
    // Would be good to provide a way to add these into the additional list.
    /// <inheritdoc />
    protected override bool ShouldRetryOn(Exception? exception)
        => exception is KingbaseException KingbaseException && _additionalErrorCodes?.Contains(KingbaseException.SqlState!) == true
