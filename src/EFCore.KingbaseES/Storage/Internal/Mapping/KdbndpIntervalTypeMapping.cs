...
public class KdbndpIntervalTypeMapping : KdbndpTypeMapping
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public sealed class KdbndpJsonTimeSpanReaderWriter : JsonValueReaderWriter<TimeSpan>
    {
        private static readonly PropertyInfo InstanceProperty = typeof(KdbndpJsonTimeSpanReaderWriter).GetProperty(nameof(Instance))!;
