...
public static class KdbndpPropertyExtensions
{
    ...
    public static KdbndpValueGenerationStrategy? SetValueGenerationStrategy(
        ...
        KdbndpValueGenerationStrategy? value,
        bool fromDataAnnotation = false)
        => (KdbndpValueGenerationStrategy?)property.SetOrRemoveAnnotation(
            KdbndpAnnotationNames.ValueGenerationStrategy, value, fromDataAnnotation)?.Value;
    ...
    public static KdbndpValueGenerationStrategy? SetValueGenerationStrategy(
        ...
        KdbndpValueGenerationStrategy? value,
        bool fromDataAnnotation = false)
        => (KdbndpValueGenerationStrategy?)overrides.SetOrRemoveAnnotation(
            KdbndpAnnotationNames.ValueGenerationStrategy, value, fromDataAnnotation)?.Value;
