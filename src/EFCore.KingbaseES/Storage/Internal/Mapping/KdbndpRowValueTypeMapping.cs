...
/// </summary>
public class KdbndpRowValueTypeMapping : RelationalTypeMapping
{
    /// <summary>
    ...
    /// </summary>
    public KdbndpRowValueTypeMapping(Type clrType)
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected KdbndpRowValueTypeMapping(RelationalTypeMappingParameters parameters)
        : base(parameters)
    {
    }
